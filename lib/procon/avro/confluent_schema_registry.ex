defmodule Procon.Avro.ConfluentSchemaRegistry do
  ...
  def register_all_avro_schemas() do
    Procon.Helpers.olog(
      "Registering all avro schema in confluent schema registry",
  ...
  def register_schema(filename) do
    ...
    |> case do
      {:error, :conflict} ->
        Procon.Helpers.olog(
          "🎃🍾🍾🍾 Procon.Avro.ConfluentSchemaRegistry > register_schema : schema #{schema_ref} already registered in confluent schema registry as #{schema_ref}.",
          Procon.Avro.ConfluentSchemaRegistryError
        )
      ...
      {:ok, schema_with_id} ->
        Procon.Helpers.olog(
          "🎃🍾🍾🍾 Procon.Avro.ConfluentSchemaRegistry > register_schema : schema #{schema_ref} registered in confluent schema registry as #{schema_ref}.",
          Procon.Avro.ConfluentSchemaRegistryOk
        )
  ...
  def register_key_schema({schema_ref, schema_with_id}, generic_key_schema) do
    ...
    |> case do
      {:error, :conflict} ->
        Procon.Helpers.olog(
          "🎃🍾🍾🍾 Procon.Avro.ConfluentSchemaRegistry > register_key_schema : schema #{schema_ref}-key already registered in confluent schema registry as #{schema_ref}.",
          Procon.Avro.ConfluentSchemaRegistry
        )
      ...
      {:ok, _schema_with_id} ->
        Procon.Helpers.olog(
          "🎃🍾🍾🍾 Procon.Avro.ConfluentSchemaRegistry > register_schema : schema #{schema_ref}-key registered in confluent schema registry as #{schema_ref}.",
          Procon.Avro.ConfluentSchemaRegistry
        )
